 ...
 *
 *avr-gcc -mmcu=atmega644p -DF_CPU=12000000 -Wall -Os -Wl,-u,vfprintf -lprintf_flt -lm  eb.c -o eb.elf -Wl,-u,vfprintf -lprintf_flt -lm
 *avr-objcopy -O ihex eb.elf eb.hex
 *avrdude -c usbasp -p m644p -U flash:w:eb.hex
 */
